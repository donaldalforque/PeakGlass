...
Public Function Global_Data(ByVal Data As String) As ADODB.Recordset
    ...
    Select Case Data
        ...
        Case "Uom"
            ...
            Set rec = cmd.Execute
        Case "Sets"
            cmd.CommandText = "BASE_Set_Get"
            Set rec = cmd.Execute
        Case "CutSizePricing"
            cmd.CommandText = "BASE_CutSizePricing_Get"
            Set rec = cmd.Execute
        Case "CutSizePricingReference"
            cmd.CommandText = "BASE_CutSizePricingReference_Get"
            Set rec = cmd.Execute
        Case "IrregularCutSizePricingReference"
            cmd.CommandText = "BASE_IrregularCutSizePricingReference_Get"
            Set rec = cmd.Execute
        Case "MetricUnit"
            cmd.CommandText = "BASE_MetricUnit_Get"
            Set rec = cmd.Execute
        Case "Room"
            cmd.CommandText = "BASE_Room_Get"
            Set rec = cmd.Execute
        Case "Slot"
            cmd.CommandText = "BASE_Slot_Get"
            Set rec = cmd.Execute
        Case "UomConversion"
