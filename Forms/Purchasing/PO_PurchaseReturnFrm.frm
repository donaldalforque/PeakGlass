...
Begin VB.Form PO_PurchaseReturnFrm 
   ...
   Begin VB.PictureBox pic_Cancelled 
      ...
      Height          =   2295
      Left            =   -99999
      Picture         =   "PO_PurchaseReturnFrm.frx":868E
      ScaleHeight     =   2295
      ScaleWidth      =   6195
      TabIndex        =   19
      Top             =   2640
   ...
   Begin VB.PictureBox picPaid 
      ...
      Height          =   1860
      Left            =   -9960
      Picture         =   "PO_PurchaseReturnFrm.frx":1932A
      ScaleHeight     =   1860
      ScaleWidth      =   5250
      TabIndex        =   16
      Top             =   2640
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":222BB
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":28B1D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":2F37F
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":35BE1
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":35E56
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PO_PurchaseReturnFrm.frx":364C7
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame Body_Frame1 
      ...
      Begin VB.Frame Frame_Footer 
         ...
         Begin VB.Label Label18 
            ...
            Height          =   285
            Left            =   7200
            MouseIcon       =   "PO_PurchaseReturnFrm.frx":3CD29
      ...
      Begin VB.Frame Frame_Body 
         ...
         Begin VB.CommandButton btnItemSearch 
            Height          =   330
            Left            =   4320
            Picture         =   "PO_PurchaseReturnFrm.frx":3CE7B
            Style           =   1  'Graphical
            TabIndex        =   32
            Top             =   240
            Width           =   375
...
Option Explicit
Public StatusId, VendorId, PurchaseReturnId, id As Integer
    ...
    If Validated = True Then
        ...
        For Each item In lvItems.ListItems
            If AllowNegativeInventory = False Then
                ...
                Set cmd = New ADODB.Command
                cmd.ActiveConnection = con
                cmd.CommandText = "INV_ProductReserveByPurchaseReturn_Update"
                cmd.CommandType = adCmdStoredProc
                ...
                cmd.Parameters.Append cmd.CreateParameter("@Quantity", adDecimal, adParamInput, , NVAL(item.SubItems(12)) * NVAL(item.SubItems(4)))
                                      cmd.Parameters("@Quantity").Precision = 18
                                      cmd.Parameters("@Quantity").NumericScale = 2
                cmd.Parameters.Append cmd.CreateParameter("@UserId", adInteger, adParamInput, , UserId)
                cmd.Execute
                item.SubItems(11) = cmd.Parameters("@ReserveId")
            End If
            ...
            cmd.Parameters.Append cmd.CreateParameter("@ReceiveId", adInteger, adParamInput, , item.SubItems(11))
            If item.text = "" Then
