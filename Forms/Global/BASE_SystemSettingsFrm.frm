...
Begin VB.Form BASE_SystemSettingsFrm 
   ...
   Begin VB.Frame FRE_Inventory 
      ...
      Begin VB.CommandButton Command10 
         ...
         Width           =   2175
      End
      Begin VB.CommandButton btnCutSize 
         Appearance      =   0  'Flat
         Caption         =   "Cut Size Reference"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.CommandButton Command8 
         Appearance      =   0  'Flat
         Caption         =   "Cut Size Name Template"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label Label23 
         ...
         Caption         =   "Create and setup inventory alert dates and frequency so you get updated with your products available quantity."
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label15 
         BackStyle       =   0  'Transparent
         Caption         =   "Setup inventory alerts for products with low inventory"
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label14 
         BackStyle       =   0  'Transparent
         Caption         =   "Allows you to setup standard cut size prices."
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label13 
         BackStyle       =   0  'Transparent
         Caption         =   "Allows you to setup name templates of cut size pricing."
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.Label Label11 
         BackStyle       =   0  'Transparent
         Caption         =   "Purchase order charges."
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame FRE_Main 
      ...
      Begin VB.Frame FRE_POS 
         ...
         Begin VB.CommandButton btnShrinkages 
            ...
            Width           =   2175
         End
         Begin VB.CommandButton btnCharges 
            Appearance      =   0  'Flat
            Caption         =   "Charges"
            BeginProperty Font 
               Name            =   "Calibri"
...
Private Sub btnTransferStock_Click()
    ...
    FRE_Inventory.Visible = True
End Sub

Private Sub Command10_Click()
    INV_AlertSettingsFrm.Show (1)
End Sub
