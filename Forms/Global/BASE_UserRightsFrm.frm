...
Begin VB.Form BASE_UserRightsFrm 
   ...
   Begin VB.Frame Frame_Main 
      ...
      Begin VB.ComboBox cmbAdmin 
         ...
         Left            =   1650
         List            =   "BASE_UserRightsFrm.frx":0016
      ...
      Begin VB.ComboBox cmbRoles 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "BASE_UserRightsFrm.frx":0027
         Left            =   1650
         List            =   "BASE_UserRightsFrm.frx":0029
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   1800
         Width           =   2415
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   240
         Picture         =   "BASE_UserRightsFrm.frx":002B
         Top             =   360
         Width           =   480
      End
    ...
    Select Case data
        Case "User"
            ...
            If Not rec.EOF Then
                ...
                cmbAdmin.text = rec!isAdministrator
...
If UserId <> 1 Then
    MsgBox "User not allowed to modify.", vbCritical
    Exit Sub
End If
On Error GoTo ErrHandler
    ...
    Else
        ...
        cmd.Parameters.Append cmd.CreateParameter("@isAdministrator", adBoolean, adParamInput, , cmbAdmin.text)
        cmd.Execute
        con.Close
