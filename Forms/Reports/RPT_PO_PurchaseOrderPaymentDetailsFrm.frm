...
Private Sub btnGenerate_Click()
    ...
    sql = "SELECT PO_PurchaseOrder.OrderNumber,PO_PurchaseOrder.Date,PO_PurchaseOrder.NetAmount,PO_PurchaseOrder.OutStandingBalance," & _
           ...
           "PO_Payment.CheckDate FROM (Peak.dbo.PO_PurchaseOrder PO_PurchaseOrder INNER JOIN Peak.dbo.BASE_Customer BASE_Customer ON " & _
           "PO_PurchaseOrder.CustomerId = BASE_Customer.CustomerId) INNER JOIN Peak.dbo.PO_Payment PO_Payment ON " & _
