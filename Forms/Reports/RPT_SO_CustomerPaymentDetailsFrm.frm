...
Private Sub btnGenerate_Click()
    ...
    sql = "SELECT BASE_Customer.CustomerId,BASE_Customer.Name,SO_SalesOrder.OrderNumber,SO_SalesOrder.Date," & _
          ...
          "SO_Payment.CheckDate,SO_Payment.CheckAmount FROM (Peak.dbo.BASE_Customer BASE_Customer INNER JOIN Peak.dbo.SO_SalesOrder SO_SalesOrder ON " & _
          "BASE_Customer.CustomerId = SO_SalesOrder.CustomerId) INNER JOIN Peak.dbo.SO_Payment SO_Payment ON " & _
