...
Private Sub btnGenerate_Click()
    ...
    sql = "SELECT PO_PurchaseOrder.VendorId,PO_PurchaseOrder.Total,PO_PurchaseOrder.OutStandingBalance," & _
          "BASE_Vendor.Name FROM Peak_GM.dbo.PO_PurchaseOrder PO_PurchaseOrder INNER JOIN Peak_GM.dbo.BASE_Vendor BASE_Vendor ON " & _
          ...
          "WHERE GLOBAL_DocStatus.StatusId = 2 AND PO_PurchaseOrder.OutStandingBalance > 0 " & Vendor & OrderBy
