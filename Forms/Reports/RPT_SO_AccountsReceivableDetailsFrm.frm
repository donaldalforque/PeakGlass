...
'    If chkAgingAccounts.value = 0 Then
        sql = "SELECT SO_SalesOrder.OrderNumber,SO_SalesOrder.Date,SO_SalesOrder.DueDate,SO_SalesOrder.ReferenceNumber, " & _
              "SO_SalesOrder.Balance,BASE_Customer.CustomerId,BASE_Customer.CustomerCode,BASE_Customer.Name,SO_Invoice.Total FROM " & _
              "Peak.dbo.SO_SalesOrder SO_SalesOrder INNER JOIN Peak.dbo.BASE_Customer BASE_Customer ON SO_SalesOrder.CustomerId = BASE_Customer.CustomerId " & _
