...
'        End Select
    ...
    sql = "SELECT SO_SalesOrder.OrderNumber,SO_SalesOrder.Date,SO_SalesOrder.DueDate,SO_SalesOrder.InterestRate," & _
          ...
          "SO_Invoice.Total From (((Peak.dbo.SO_SalesOrder SO_SalesOrder INNER JOIN Peak.dbo.GLOBAL_DocStatus GLOBAL_DocStatus ON " & _
          "SO_SalesOrder.StatusId = GLOBAL_DocStatus.StatusId) INNER JOIN Peak.dbo.BASE_Customer BASE_Customer ON " & _
          "SO_SalesOrder.CustomerId = BASE_Customer.CustomerId) LEFT OUTER JOIN Peak.dbo.BASE_Terms BASE_Terms ON " & _
          "SO_SalesOrder.TermId = BASE_Terms.TermId) INNER JOIN Peak.dbo.SO_Invoice SO_Invoice ON SO_SalesOrder.SalesOrderId = SO_Invoice.SalesOrderId " & _
...
'    sql = "SELECT SO_SalesOrder.OrderNumber,SO_SalesOrder.Date,SO_SalesOrder.DueDate,SO_SalesOrder.InterestRate," & _
'          "SO_SalesOrder.total , SO_SalesOrder.balance, GLOBAL_DocStatus.Status, BASE_Customer.Name, BASE_Terms.Terms " & _
'          "FROM ((Peak.dbo.SO_SalesOrder SO_SalesOrder INNER JOIN Peak.dbo.GLOBAL_DocStatus GLOBAL_DocStatus ON " & _
'          "SO_SalesOrder.StatusId = GLOBAL_DocStatus.StatusId) INNER JOIN Peak.dbo.BASE_Customer BASE_Customer ON " & _
'          "SO_SalesOrder.CustomerId = BASE_Customer.CustomerId) LEFT OUTER JOIN Peak.dbo.BASE_Terms BASE_Terms ON " & _
