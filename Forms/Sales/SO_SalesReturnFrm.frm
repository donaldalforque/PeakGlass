...
Begin VB.Form SO_SalesReturnFrm 
   ...
   Begin VB.PictureBox picCompleted 
      ...
      Height          =   2295
      Left            =   -9999
      Picture         =   "SO_SalesReturnFrm.frx":10C9C
      ScaleHeight     =   2295
      ScaleWidth      =   6195
      TabIndex        =   29
      Top             =   2640
   ...
   Begin VB.Frame Body_Frame1 
      ...
      Begin VB.Frame Frame_Body 
         ...
         Begin VB.CommandButton btnItemSearch 
            Height          =   330
            Left            =   4320
            Picture         =   "SO_SalesReturnFrm.frx":1932A
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   240
            Width           =   375
      ...
      Begin VB.Frame Frame_Footer 
         ...
         Begin VB.ComboBox cmbPricing 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "SO_SalesReturnFrm.frx":1954E
            Left            =   1200
            List            =   "SO_SalesReturnFrm.frx":1955E
         ...
         Begin VB.Label Label30 
            ...
            Height          =   285
            Left            =   7200
            MouseIcon       =   "SO_SalesReturnFrm.frx":1959C
      ...
      Begin VB.Frame Frame_Header1 
         ...
         Begin VB.ComboBox cmbTerms 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "SO_SalesReturnFrm.frx":196EE
            Left            =   5520
            List            =   "SO_SalesReturnFrm.frx":196F0
            Style           =   2  'Dropdown List
            TabIndex        =   4
            Top             =   0
            Width           =   1215
   ...
   Begin VB.PictureBox picPaid 
      ...
      Height          =   1860
      Left            =   -9840
      Picture         =   "SO_SalesReturnFrm.frx":196F2
      ScaleHeight     =   1860
      ScaleWidth      =   5250
      TabIndex        =   25
      Top             =   2640
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":22683
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":28EE5
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":2F747
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":35FA9
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":3621E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesReturnFrm.frx":3688F
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'        cmd.ActiveConnection = con
'        cmd.CommandType = adCmdStoredProc
'        cmd.CommandText = "INV_ProductReserve_StatusUpdate"
'        If StatusId <> 7 Then '7=Cancelled
'            cmd.Parameters.Append cmd.CreateParameter("@StatusId", adInteger, adParamInput, , 1)
'        Else
'            cmd.Parameters.Append cmd.CreateParameter("@StatusId", adInteger, adParamInput, , 0)
'        End If
...
'                Set cmd = New ADODB.Command
'                cmd.ActiveConnection = con
'                cmd.CommandText = "INV_ProductReserveBySalesReturn_Update"
'                cmd.CommandType = adCmdStoredProc
'                cmd.Parameters.Append cmd.CreateParameter("@ReserveId", adInteger, adParamInputOutput, , Val(item.SubItems(14)))
'                cmd.Parameters.Append cmd.CreateParameter("@SalesReturnId", adInteger, adParamInput, , SalesReturnId)
'                cmd.Parameters.Append cmd.CreateParameter("@ProductId", adInteger, adParamInput, , Val(item.SubItems(9)))
'                cmd.Parameters.Append cmd.CreateParameter("@Quantity", adDecimal, adParamInput, , NVAL(item.SubItems(13)) * NVAL(item.SubItems(4)))
'                                      cmd.Parameters("@Quantity").Precision = 18
'                                      cmd.Parameters("@Quantity").NumericScale = 2
'                cmd.Parameters.Append cmd.CreateParameter("@UserId", adInteger, adParamInput, , UserId)
'                cmd.Execute
'                item.SubItems(14) = cmd.Parameters("@ReserveId")
'            End If
...
'        If chkWithdraw.value = Checked Then
'            Dim WarehouseWithdrawalId As Integer
'
'            Set cmd = New ADODB.Command
'            cmd.ActiveConnection = con
'            cmd.CommandType = adCmdStoredProc
...
'            cmd.Parameters.Append cmd.CreateParameter("@StatusId", adInteger, adParamInput, , 1)
'            cmd.Parameters.Append cmd.CreateParameter("@CustomerId", adInteger, adParamInput, , CustomerId)
'            cmd.Parameters.Append cmd.CreateParameter("@ReferenceNumber", adVarChar, adParamInput, 500, txtOrderNumber.text)
'            cmd.Parameters.Append cmd.CreateParameter("@Salesman", adVarChar, adParamInput, 500, txtSalesman.text)
'            cmd.Parameters.Append cmd.CreateParameter("@Driver", adVarChar, adParamInput, 500, "")
'            cmd.Parameters.Append cmd.CreateParameter("@WarehouseManager", adVarChar, adParamInput, 500, "")
...
'                    cmd.CommandType = adCmdStoredProc
'
'                    cmd.Parameters.Append cmd.CreateParameter("@WarehouseWithdrawalLineId", adInteger, adParamInputOutput, , 0)
...
'                    cmd.Parameters.Append cmd.CreateParameter("@Uom", adVarChar, adParamInput, 250, item.SubItems(5))
'                    cmd.Parameters.Append cmd.CreateParameter("@StatusId", adInteger, adParamInput, , StatusId)
'                    cmd.Parameters.Append cmd.CreateParameter("@Remarks", adVarChar, adParamInput, 250, "Order: " & txtOrderNumber.text)
'                    cmd.Parameters.Append cmd.CreateParameter("@SalesReturnId", adInteger, adParamInput, , SalesReturnId)
...
Private Sub btnPick_Click()
    ...
    End If
    Dim x As Variant
    x = MsgBox("Are you sure you want to complet this order?", vbQuestion + vbYesNo)
    If x = vbYes Then
        Save (2)
    End If
'    If StatusId >= 6 Then
...
'                cmd.Parameters.Append cmd.CreateParameter("@SalesReturnId", adInteger, adParamInput, , SO_SalesReturnFrm.SalesReturnId)
...
'            'PO_ReceiveOrderFrm.SalesReturnIdx = Me.SalesReturnId
...
'            End If
        ...
        Case 4 'Cancel
            If StatusId = 2 Then
                MsgBox "Cannot cancel a completed order.", vbCritical, "Error!"
                Exit Sub
            End If
            If SalesReturnId <> 0 Then
