...
Begin VB.Form SO_SalesOrderFrm 
   ...
   Begin VB.PictureBox pic_Cancelled 
      ...
      Height          =   2295
      Left            =   -9999
      Picture         =   "SO_SalesOrderFrm.frx":8F91
      ScaleHeight     =   2295
      ScaleWidth      =   6195
      TabIndex        =   50
      Top             =   2640
   ...
   Begin VB.PictureBox picCompleted 
      ...
      Height          =   2295
      Left            =   -9999
      Picture         =   "SO_SalesOrderFrm.frx":19C2D
      ScaleHeight     =   2295
      ScaleWidth      =   6195
      TabIndex        =   49
      Top             =   2640
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":222BB
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":28B1D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":2F37F
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":35BE1
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":35E56
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SO_SalesOrderFrm.frx":364C7
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame Body_Frame1 
      ...
      Begin VB.Frame Frame_Header1 
         ...
         Begin VB.ComboBox cmbTerms 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "SO_SalesOrderFrm.frx":3CD29
            Left            =   5520
            List            =   "SO_SalesOrderFrm.frx":3CD2B
            Style           =   2  'Dropdown List
            TabIndex        =   2
            Top             =   0
            Width           =   1215
      ...
      Begin VB.Frame Frame_Footer 
         ...
         Begin VB.ComboBox cmbPricingScheme 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "SO_SalesOrderFrm.frx":3CD2D
            Left            =   1200
            List            =   "SO_SalesOrderFrm.frx":3CD3D
            Style           =   2  'Dropdown List
            TabIndex        =   12
            Top             =   1680
            Width           =   3135
         ...
         Begin VB.Label Label30 
            ...
            Height          =   285
            Left            =   7200
            MouseIcon       =   "SO_SalesOrderFrm.frx":3CD7B
      ...
      Begin VB.Frame Frame_Body 
         ...
         Begin VB.CommandButton btnItemSearch 
            Height          =   330
            Left            =   4320
            Picture         =   "SO_SalesOrderFrm.frx":3CECD
            Style           =   1  'Graphical
            TabIndex        =   18
            Top             =   240
            Width           =   375
...
'        On Error GoTo ErrorHandler
        ...
        For Each item In lvItems.ListItems
            If AllowNegativeInventory = False Then
                ...
                Set cmd = New ADODB.Command
                cmd.ActiveConnection = con
                cmd.CommandText = "INV_ProductReserveBySalesOrder_Update"
                cmd.CommandType = adCmdStoredProc
