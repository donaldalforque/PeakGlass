    ...
    With INV_NewStockFrm
        If .lvItemList.Visible = True Then 'New List
            ...
            Set item = .lvItems.ListItems.add(, , .lvItemList.SelectedItem.text) 'ProductId
                ...
                item.SubItems(11) = FormatNumber(NVAL(txtDiscount.text))
                item.SubItems(13) = cmbLocation.text
                item.SubItems(14) = cmbUnit.ItemData(cmbUnit.ListIndex)
                item.Selected = True
                item.EnsureVisible
                Unload Me
        ...
        Else
            ...
            .lvItems.SelectedItem.SubItems(11) = FormatNumber(NVAL(txtDiscount.text))
            .lvItems.SelectedItem.SubItems(13) = cmbLocation.text
            .lvItems.SelectedItem.SubItems(14) = cmbUnit.ItemData(cmbUnit.ListIndex)
            Unload Me
        End If
        .CountTotal
    End With
...
Private Sub Form_Load()
    ...
    With INV_NewStockFrm
        If .lvItemList.Visible = False Then
            ...
            cmbLocation.text = .lvItems.SelectedItem.SubItems(13)
            ...
            txtDiscount.text = .lvItems.SelectedItem.SubItems(11)
