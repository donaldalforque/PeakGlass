...
Begin VB.Form INV_AdjustStockFrm_Old 
   BackColor       =   &H00FFFFFF&
   ...
   End
End
Attribute VB_Name = "INV_AdjustStockFrm_Old"
    ...
    Select Case KeyCode
        Case vbKeyReturn
            If lvItemList.ListItems.Count > 0 Then
                INV_AdjustStockOptFrm_Old.isFormSearch = False
                INV_AdjustStockOptFrm_Old.txtQuantity.text = "1"
                INV_AdjustStockOptFrm_Old.Show (1)
            End If
    End Select
End Sub
