VERSION 5.00
Begin VB.Form INV_AdjustStockOptFrm_Old 
   ...
   End
End
Attribute VB_Name = "INV_AdjustStockOptFrm_Old"
...
Private Sub Form_Load()
    ...
    If isModify = True Then
        cmd.Parameters.Append cmd.CreateParameter("@ProductId", adInteger, adParamInput, , INV_AdjustStockFrm_Old.lvItems.SelectedItem.SubItems(9))
    Else
        cmd.Parameters.Append cmd.CreateParameter("@ProductId", adInteger, adParamInput, , INV_AdjustStockFrm_Old.lvItemList.SelectedItem.text)
    End If
    Set rec = cmd.Execute
